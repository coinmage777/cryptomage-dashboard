...
const P = [
  ...
  {id:4,n:"Genius",tier:1,cat:"PerpDEX",ch:"Multi-chain",logo:TW("2001105770780483585/Ph9MFPHV_400x400.jpg"),st:"진행중",rw:"대형",fund:"YZi Labs (CZ)",dist:"미정",tge:"Apr 12, 2026",hot:true,
  ...
  {id:7,n:"Glider",tier:1,cat:"DeFi",ch:"Multi-chain",logo:TW("2008111141957021696/fUFRZjS3_400x400.jpg"),st:"진행중",rw:"대형",fund:"a16z, Coinbase",dist:"미정",tge:"미정",
    ...
    <div className="space-y-5">
      <div className="pt-6 pb-2">
        ...
        <div className="grid grid-cols-1 gap-3 max-w-xs">
          {[{v:P.length,l:"미상장 프로젝트",c:"from-violet-500/20 to-fuchsia-500/10",t:"text-white",I:Globe}].map((s,i)=>(
